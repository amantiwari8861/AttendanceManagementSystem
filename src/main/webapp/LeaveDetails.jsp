...
<%@page import="com.nobious.bean.Leave"%>
...
<%@include file="components/navbar.jsp" %>
	<h1>
		<i><center>All Employees Leave Details</center></i>
	</h1>
	<div class="container">
		<br> <br>
		<table id="mytable" class="table table-striped" style="width: 100%">
			<% AdminDao dao=new AdminDaoImpl();
   			 ArrayList<Leave> list=dao.getAllLeaveDetails();%>
        ...
        %>
				<tr>
					<td><%=lea.getLeaveId()%></td>
					<td><%=lea.getUsername()%></td>
					<td><%=lea.getCasualLeave()%></td>
					<td><%=lea.getSickLeave()%></td>
					<td><%=lea.getEarnedLeave()%></td>
